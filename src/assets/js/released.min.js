...
var twemoji = (function() {
  ...
  function f(b, c) {
    for (
      ...
      h &&
        (m < k.length && i.appendChild(a(k.slice(m), !0)),
  ...
  function l(a, b) {
    return (
      (b && "function" != typeof b) || (b = { callback: b }),
...
!(function(a, b) {
  function c() {
      ...
      if (!k) {
        ...
        (g = a.twemoji),
          ...
          i &&
            ...
            }).observe(j.body, { childList: !0, subtree: !0 }),
          f(j.body);
      }
    }
    function e(a) {
    ...
    return (
      b && (b.DOMReady ? d() : (b.readyCallback = d)), { parse: f, test: e }
    );
  }
